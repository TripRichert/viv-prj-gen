...
Let's generate a Vivado project.  We are going to use the genvivprj_func function.  Documentation for functions in vivgen_functions.cmake is in vivgen_functions.adoc.
