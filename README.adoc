...
can be used to generate a vivado project to develop this code with.

If you want a build for record,
...
can be used to add a recipe to build a bit file from source using a nonproject flow.
